...
{
  "$end", "error", "$undefined", "T_UNKNOWN", "\"string\"",
  "\"identifier\"", "$accept", "input", "block_string", "one_word", 0
};
#endif
...
#line 74 "lqsyn.y"
    { 
		if ((yyval.pnode)->tail)
			...
			(yyval.pnode)->next = (yyvsp[(2) - (2)].pnode);
		(yyval.pnode)->tail = (yyvsp[(2) - (2)].pnode);
	;}
    break;
