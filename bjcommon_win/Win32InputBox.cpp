...
{
	CWin32InputBox *_this;
  switch (message)
  {
    case WM_INITDIALOG:
    {
      ::SetWindowLongPtr(hDlg, GWLP_USERDATA, (LONG_PTR)lParam); // (LONG) changed to (LONG_PTR) for Win64, modified by bjkwon 7/25/2018
    ...
    case WM_COMMAND:
    {
           ...
           i++)
      {
        ...
        {
			_this = (CWin32InputBox *) ::GetWindowLongPtr(hDlg, GWLP_USERDATA);
          ::GetWindowText(
            _this->_hwndEditCtrl, 
